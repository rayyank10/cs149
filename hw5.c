...
//global variable to keep track of count of unique words
int count;
...
int List_Lookup(list_t *L, char *key) {
    ...
    node_t *curr = L->head;
    while (curr) {
        // changed from the book due to it being more accurate
...
int main(int argc, char **argv) {
    ...
    //initializing the hash and allocating space for it
